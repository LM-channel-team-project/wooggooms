...
function setSub(mainValue) {
  let val = ['전체'];
  if (mainValue === 'officiary') val = office;
  else if (mainValue === 'language') val = lang;
  else if (mainValue === 'employee') val = employ;
  else if (mainValue === 'hobby') val = hobby;
  else if (mainValue === 'exam') val = exam;
